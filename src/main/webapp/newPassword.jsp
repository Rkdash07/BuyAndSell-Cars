			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-5">
					...
					<div class="container bg-white rounded mt-2 mb-2 px-0">
						...
						<div class="pt-3 pb-3">
							<form class="form-horizontal" action="NewPasswords" method="POST">
								<!-- User Name Input -->
						...
						<div class="mx-0 px-0 bg-light">
							...
							<div class="pt-2">
								<div class="row justify-content-center">
									<h5>
										<strong>Don't have an Account?</strong><span><a href="RegisterServlet"
											class="text-danger"> Register here</a></span>
									</h5>
								</div>
								<div
